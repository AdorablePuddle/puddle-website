	...
	return (
		<article className = "blog-content">
            ...
            <div className = "flex flex-col float-left p-3">
                <img aria-labelledby = "celeste-label" className = "w-140" src = {heart} alt = "Screenshot of Starfruit Supernova, completed in 19.75 hours." />
                <p className = "caption" id = "celeste-label">
            ...
            <div className = "flex flex-col float-right p-3">
                <img aria-labelledby = "illustration-label" className = "w-90" src = {art} alt = "Image of an anime girl illustration." />
                <p className = "caption" id = "illustration-label">
